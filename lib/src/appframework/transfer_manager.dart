    ...
    _presentationManager.eventStream.listen((event) {
      ...
      switch (event.type) {
        ...
        case DATA_RECEIVED:
          ...
          _controller
              .add(Event(AdHocType.onDataReceived, device: device, data: data));
          break;
        ...
        case FORWARD_DATA:
          ...
          _controller
              .add(Event(AdHocType.onForwardData, device: device, data: data));
          break;
        ...
        case GROUP_DATA:
          ...
          _controller.add(
              Event(AdHocType.onGroupDataReceived, device: device, data: data));
          break;

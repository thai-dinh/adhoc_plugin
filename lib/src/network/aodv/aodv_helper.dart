...
/*------------------------------Public methods-------------------------------*/
  ...
  EntryRoutingTable? addEntryRoutingTable(String destAddress, String next,
      int hop, int seq, int lifetime, List<String> precursors) {
    var entry =
        EntryRoutingTable(destAddress, next, hop, seq, lifetime, precursors);
